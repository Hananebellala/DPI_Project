...
@Component({
  selector: 'patient-page-diagnostic',
  standalone: true,
  imports: [
  ...
  templateUrl: './patient-page-diagnostic.component.html',
  styleUrls: ['./patient-page-diagnostic.component.scss'],
})
export class PatientPageDiagnosticComponent implements OnInit {
