...
urlpatterns = [
    ...
    path('check-email/', check_mail, name='check_email'),
    path('getStaff/', get_all_staff, name='getStaff'),
    path('comptemedecin/delete-by-email/<str:email>/', delete, name='delete_member'),
    ...
    path('save_contact/', save_contact_form, name='save_contact'),
    path('dpi/', get_patient_by_email, name='get_patient_by_email'),
